...
class Order(models.Model):
    placer = models.ForeignKey(Profile,on_delete=models.SET_NULL,related_name="placer",null=True) 
...
class Transaction(models.Model):
    sender = models.ForeignKey(Profile,on_delete=models.SET_NULL,related_name="sender",null=True)
    receiver = models.ForeignKey(Profile,on_delete=models.SET_NULL,related_name="receiver",null=True)
    order = models.ForeignKey(Order,on_delete=models.SET_NULL,related_name="order",null = True)
